...
INSERT INTO "new_Contrato" ("atualizadoEm", "bancoId", "convenioId", "criadoEm", "dataAprovacao", "dataDigitacao", "dataPagamento", "id", "leadId", "numero", "observacoes", "prazo", "produtoId", "propostaId", "status", "taxa", "valorContratado", "valorLiberado", "valorParcela", "vendedorId") SELECT "atualizadoEm", "bancoId", "convenioId", "criadoEm", "dataAprovacao", "dataDigitacao", "dataPagamento", "id", "leadId", "numero", "observacoes", "prazo", "produtoId", "propostaId", "status", "taxa", "valorContratado", "valorLiberado", "valorParcela", "vendedorId" FROM "Contrato";
DROP TABLE "Contrato";
