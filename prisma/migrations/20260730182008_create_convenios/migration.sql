...
INSERT INTO "new_Lead" ("atualizadoEm", "banco", "bancoId", "convenio", "cpf", "criadoEm", "email", "id", "nome", "observacoes", "origem", "produto", "status", "telefone", "valorLiberado", "valorSolicitado", "vendedorId", "whatsapp") SELECT "atualizadoEm", "banco", "bancoId", "convenio", "cpf", "criadoEm", "email", "id", "nome", "observacoes", "origem", "produto", "status", "telefone", "valorLiberado", "valorSolicitado", "vendedorId", "whatsapp" FROM "Lead";
DROP TABLE "Lead";
